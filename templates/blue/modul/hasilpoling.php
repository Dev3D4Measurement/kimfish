...
echo "<div class='right'>
      <h2>Maaf, anda sudah pernah melakukan pemilihan terhadap jajak pendapat ini.</h2>";
      }
      else{
...
echo "<h2>Terima kasih atas partisipasi anda mengikuti polling kami</h2>";
  
echo "<p>Hasil Jajak Pendapat saat ini:</p><br/>";
...
echo "<tr><td width='120'><b>$s[pilihan] ($s[rating])</b></td><td> 
