...
echo "<div class='right'>
	  ...
	  $hubungi=mysql_query("SELECT * FROM hubungi ORDER BY id_hubungi DESC");
      while($b=mysql_fetch_array($hubungi)){
	   }
echo "<form id='hubungi' name='hubungi' method='post' action='$f[folder]/config/proses_email.php'>
      ...
      <tr>
      <td height='40'><label for='subjek'>Subjek</label></td>
      <td><input type='text' class='validate[custom[judul]]' name='subjek' id='subjek' value='' /></td>
      <td>&nbsp;</td>
      </tr>
