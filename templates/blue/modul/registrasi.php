...
echo "<form name='contact-form' method='post' action='proses_registrasi.php'>
	  <table width='75%' border='0' cellspacing='0' cellpadding='0'>
	  <tr>
      <td height='40'><label for='namalengkap'>Username</label></td>
      <td><input type='text'  name='username' id='namalengkap' value='' /></td>
      <td id='errOffset'>&nbsp;</td>
      </tr>
	  ...
	  <tr>
      <td height='40'><label for='tlp'>Nama Lengkap</label></td>
      <td><input type='text' name='nama' id='password' value='' /></td>
      <td id='errOffset'>&nbsp;</td>
      </tr>
	  
	  <tr>
      <td height='40'><label for='tlp'>No Hp</label></td>
      <td><input type='text' name='nohp' id='password' value='' /></td>
      <td id='errOffset'>&nbsp;</td>
      </tr>
	  
	  <tr>
      <td height='40'><label for='tlp'>Alamat</label></td>
      <td><input type='text' name='alamat' id='password' value='' /></td>
      <td id='errOffset'>&nbsp;</td>
      </tr>
		...
		<tr>
          <td valign='top'>&nbsp;</td>
          <td colspan='2'>
			<input type='submit' value='Daftar'  name='login' />
