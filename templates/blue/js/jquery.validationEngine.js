...
(function($) {
	...
	if($.validationEngineLanguage){				// IS THERE A LANGUAGE LOCALISATION ?
		...
		allRules = 	{"required":{    			// Add your regex rules here, you can take telephone as an example
					...
					"telephone":{
						"regex":"/^[.0-9\-\(\)\ ]+$/",
						"alertText":"* Nomor telepon harus di isi"},	
					"noorder":{
						"regex":"/^[0-9\-\(\)\ ]+$/",
						"alertText":"* No.Order harus di isi"},	
					"tglpembayaran":{
						"regex":"/^[0-9]{4}\-\[0-9]{1,2}\-\[0-9]{1,2}$/",
                         "alertText":"* Tgl. pembayaran harus di isi "},
					"jmlhpembayaran":{
						"regex":"/^[\.a-z0-9_\-]+$/",
						"alertText":"* Jmlh. pembayaran harus di isi"},
					"email":{
						"regex":"/^[\.a-z0-9_\-]+[@][a-z0-9_\-]+([.][a-z0-9_\-]+)+[a-z]{1,4}$/i",
						"alertText":"* Email harus di isi"},	
					"date":{
                         "regex":"/^[0-9]{4}\-\[0-9]{1,2}\-\[0-9]{1,2}$/",
                         "alertText":"* Invalid date, must be in YYYY-MM-DD format"},
					"norekening":{
						"regex":"/^[0-9\-\(\)\ ]+$/",
						"alertText":"* Nomor rekening harus di isi"},
					"namarekening":{
						"regex":"/^[a-zA-Z\ \']+$/",
						"alertText":"* Nama rekening harus di isi"},
					"judul":{
						"regex":"/^[a-zA-Z\ \']+$/",
						"alertText":"* Subjek harus di isi"},
					"nama":{
						"regex":"/^[a-zA-Z\ \']+$/",
						"alertText":"* Nama harus di isi"},
					"onlyNumber":{
						"regex":"/^[0-9\ ]+$/",
						"alertText":"* Kode harus di isi"},	
					"noSpecialCaracters":{
						"regex":"/^[0-9a-zA-Z]+$/",
